...
Invoke-Native g++ -std=c++17 -Wall -Wextra -pedantic -O2 -pipe -Iinclude src/core.cpp src/gui/application.cpp tests/gui_model_tests.cpp -o lifeengine_gui_model_tests.exe
...
Invoke-Native g++ -std=c++17 -Wall -Wextra -pedantic -O2 -pipe -Iinclude src/core.cpp src/gui/application.cpp src/gui/main.cpp src/gui/win32_app.cpp -o lifeengine_gui.exe -lcomctl32 -lgdi32 -luser32
}
finally {
    Pop-Location
}
